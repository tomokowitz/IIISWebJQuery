    ...
    base: {
        ...
        mapping: {
            /** The name of the object in the server response, that contains array with records, that needs to be display in the grid.
                ...
                * @default "records"
                */
            // Modified dataField to map to JsonReadingListViewModel TVO 6/27/2016
            dataField: "JsonReadings",
            //dataField: "records",
            /** The name of the object in the server response, that contains the number of all records on the server.
                ...
                * @default "total"
                */
            // Modified totalRecordsField to map to JsonTotal TVO 6/27/2016
            totalRecordsField: "JsonTotal"
...
﻿gj.grid.private = {
    ...
    GetRecords: function (data, response) {
        ...
        if ($.isArray(response)) {
            records = response;
        } else if (data && data.mapping && $.isArray(response[data.mapping.dataField])) { // field mapping used here TVO
    ...
    ReloadPager: function ($grid, data, response) {
        ...
        totalRecords = response[data.mapping.totalRecordsField]; // field mapping used here TVO
...
gj.grid.public = {
    ...
    clear: function () {
        ...
        emptyResponse[data.mapping.totalRecordsField] = 0; // field mapping used here TVO
